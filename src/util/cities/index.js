/*
 * @Author: AuthorJim 
 * @Date: 2017-07-02 18:07:10 
 * @Last Modified by: AuthorJim
 * @Last Modified time: 2017-07-05 09:27:32
 */
...
var _cities = {
    cityInfo: {
        ...
        　　"西藏省": ["拉萨", "昌都", "山南", "日喀则", "那曲", "阿里", "林芝"],
        　　"陕西省": ["西安", "铜川", "宝鸡", "咸阳", "渭南", "延安", "汉中", "榆林", "安康", "商洛"],
        　　"甘肃省": ["兰州", "白银", "定西", "敦煌", "嘉峪关", "金昌", "天水", "武威", "张掖", "平凉", "酒泉", "庆阳", "临夏", "陇南", "甘南"],
        　　"青海省": ["西宁", "海东", "海北", "黄南", "海南", "果洛", "玉树", "海西"],
        　　"宁夏省": ["银川", "石嘴山", "吴忠", "固原", "中卫"],
        　　"新疆省": ["乌鲁木齐", "克拉玛依", "吐鲁番", "哈密", "和田", "阿克苏", "喀什", "克孜勒苏柯尔克孜", "巴音郭楞蒙古", "昌吉", "博尔塔拉蒙古", "伊犁哈萨克", "阿勒泰"],
